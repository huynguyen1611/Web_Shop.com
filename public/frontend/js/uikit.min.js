...
!(function (t) {
    if (
        ("function" == typeof define &&
            ...
            define("uikit", function () {
                var i =
                    window.UIkit || t(window, window.jQuery, window.document);
                return (
    ...
    if (
        ...
        (n.Utils.removeCssRules = function (t) {
            ...
            t &&
                setTimeout(function () {
                    try {
                        for (
                            u = document.styleSheets, o = 0, r = u.length;
                            r > o;
                            o++
                        ) {
                            for (
        ...
        (n.Utils.focus = function (t, e) {
            ...
            return o.length
                ? o.focus()
                : ((o = t.find(":input" + ((e && "," + e) || "")).first()),
                  o.length
                      ? o.focus()
                      : (t.attr("tabindex") ||
                            ((n = 1e3), t.attr("tabindex", n)),
                        t[0].focus(),
                        n && t.attr("tabindex", ""),
                        t));
        }),
            ...
            var o = function (e, s) {
                ...
                return (
                    ...
                    (this.options.plugins.length
                        ...
                        o.plugins[t].init &&
                            (o.plugins[t].init(a), (a.plugins[t] = !0));
                    }),
    ...
    (function (t) {
        ...
        function e() {
            (c = null),
                d.last &&
                    (void 0 !== d.el && d.el.trigger("longTap"), (d = {}));
        }
        function n() {
        ...
        t.component("stackMargin", {
                ...
                t.ready(function (i) {
                    t.$("[data-uk-margin]", i).each(function () {
                        ...
                        i.data("stackMargin") ||
                            t.stackMargin(
                                i,
                                t.Utils.options(i.attr("data-uk-margin"))
                            );
                    });
                });
            },
            ...
            (function (i) {
                (t.Utils.inlineSvg = function (e, n) {
                    t.$(e || 'img[src$=".svg"]', n || document).each(
                        function () {
                            var e = t.$(this),
                                n = e.attr("src");
                            if (!i[n]) {
            ...
            (t.Utils.getCssVar = function (t) {
                ...
                try {
                    i = JSON.parse(
                        (i = getComputedStyle(n, ":before").content.replace(
                            /^["'](.*)["']$/,
                            "$1"
                        ))
                    );
                    ...
                    t.ready(function (i) {
                        t.$("[data-uk-scrollspy]", i).each(function () {
                            ...
                            if (!i.data("scrollspy")) {
                                t.scrollspy(
                                    i,
                                    t.Utils.options(i.attr("data-uk-scrollspy"))
                                );
                            }
                        });
                    });
                ...
                var e,
                    ...
                    u = function () {
                        ...
                        for (var n = 0; n < a.length; n++)
                            t.Utils.isInView(a.eq(n), c.options) &&
                                e.push(a.eq(n));
                        if (e.length) {
                            var s,
                                u = i.scrollTop(),
                            ...
                            c.options.closest
                                ...
                                : (s = o
                                      ...
                                      .filter("a[href='#" + d.attr("id") + "']")
                                      .addClass(r)),
                                c.element.trigger("inview.uk.scrollspynav", [
                                    d,
                                    s,
                                ]);
                        }
                ...
                t.ready(function (e) {
                    t.$("[data-uk-toggle]", e).each(function () {
                        ...
                        if (!i.data("toggle")) {
                            t.toggle(
                                i,
                                t.Utils.options(i.attr("data-uk-toggle"))
                            );
                        }
                    }),
                        setTimeout(function () {
                ...
                t.$html.on(
                    ...
                    function (i) {
                        ...
                        if (!e.data("alert")) {
                            var n = t.alert(
                                e,
                                t.Utils.options(e.attr("data-uk-alert"))
                            );
                        ...
                        function (i) {
                            ...
                            if (!e.data("buttonCheckbox")) {
                                var n = t.buttonCheckbox(
                                        e,
                                        t.Utils.options(
                                            e.attr("data-uk-button-checkbox")
                                        )
                                    ),
                                    o = t.$(i.target);
                                o.is(n.options.target) && o.trigger("click");
                    ...
                    this.find(i.options.target)
                        ...
                        this.on("click", this.options.target, function (e) {
                            ...
                            n.is('a[href="#"]') && e.preventDefault(),
                                ...
                                n.attr(
                                    "aria-checked",
                                    n.hasClass(i.options.activeClass)
                                ),
                                i.trigger("change.uk.button", [n]);
                        });
                },
                    ...
                    t.$html.on(
                        ...
                        function (i) {
                            ...
                            if (!e.data("button")) {
                                t.button(
                                    e,
                                    t.Utils.options(e.attr("data-uk-button"))
                                );
                                e.trigger("click");
                            }
                        }
    ...
    (function (t) {
        ...
        t.component("dropdown", {
            ...
            boot: function () {
                ...
                t.$html.on(
                    i + ".dropdown.uikit focus pointerdown",
                    "[data-uk-dropdown]",
                    function (e) {
                        var n = t.$(this);
                        if (!n.data("dropdown")) {
                            var o = t.dropdown(
                                n,
                                t.Utils.options(n.attr("data-uk-dropdown"))
                            );
                            ("click" == e.type ||
                                ("mouseenter" == e.type &&
                                    "hover" == o.options.mode)) &&
                                o.element.trigger(i),
                        ...
                        : this.on("mouseenter", function (t) {
                              ...
                              .on("mouseleave", function () {
                                  e && clearTimeout(e),
                                      ...
                                      i.trigger("pointerleave.uk.dropdown", [
                                          i,
                                      ]);
                              })
                              .on("click", function (e) {
            ...
            checkDimensions: function () {
                if (this.dropdown.length) {
                    this.dropdown
                        .removeClass(
                            "uk-dropdown-top uk-dropdown-bottom uk-dropdown-left uk-dropdown-right uk-dropdown-stack uk-dropdown-autoflip"
                        )
                        .css({
                            topLeft: "",
                            left: "",
                    ...
                    var e,
                        ...
                        a = this.dropdown,
                        r =
                            (a.show().offset() || { left: 0, top: 0 },
                            a.outerWidth()),
                        l = a.outerHeight(),
                        c = this.boundary.width(),
                        u =
                            (this.boundary[0] !== window &&
                    ...
                    if (
                        ...
                        switch (
                            ...
                            case "x":
                                "x" !== this.options.preventflip &&
                                    (p = o.x[u] || "right-top");
                                break;
                            case "y":
                                "y" !== this.options.preventflip &&
                                    (p = o.y[u] || "top-left");
                                break;
                            case "xy":
                                this.options.preventflip ||
                                    (p = o.xy[u] || "right-bottom");
                        }
                        p &&
                            ((e = p.split("-")),
                        ...
                        t.$("[data-uk-dropdown-overlay]", i).each(function () {
                            ...
                            i.data("dropdownOverlay") ||
                                t.dropdownOverlay(
                                    i,
                                    t.Utils.options(
                                        i.attr("data-uk-dropdown-overlay")
                                    )
                                );
                        });
                    });
                    ...
                    (this.justified = this.options.justify
                        ...
                        this.on({
                                ...
                                e.dropdown.element.removeClass("uk-open"),
                                    e.overlay
                                        ...
                                        .animate(
                                            ...
                                            e.options.duration,
                                            function () {
                                                e.dropdown.dropdown.css(
                                                    "visibility",
                                                    ""
                                                ),
                                                    e.dropdown.element.addClass(
                                                        "uk-open"
                                                    ),
                                                    t.Utils.checkDisplay(
                                                        e.dropdown.dropdown,
                                                        !0
                                                    );
                                            }
                            ...
                            "hide.uk.dropdown": function () {
                                e.overlay
                                    .stop()
                                    .animate({ height: 0 }, e.options.duration);
                            },
    ...
    (function (t) {
                      ...
                      : (i =
                            "string" == typeof i || "number" == typeof i
                                ...
                                : t
                                      .$("<div></div>")
                                      .html(
                                          "UIkit.modal Error: Unsupported data type: " +
                                              typeof i
                                      )),
        ...
        t.$win.on(
            ...
            t.component("modal", {
                ...
                init: function () {
                    if ((e || (e = t.$("body")), this.element.length)) {
                        ...
                        (this.paddingdir =
                            "padding-" +
                            ("left" == t.langdirection ? "right" : "left")),
                    ...
                    if (this.isActive() || t) {
                        ...
                        if (
                            ...
                            var n = this.dialog.outerHeight(),
                                o =
                                    parseInt(
                                        this.dialog.css("margin-top"),
                                        10
                                    ) +
                                    parseInt(
                                        this.dialog.css("margin-bottom"),
                                        10
                                    );
                ...
                updateScrollable: function () {
                    var t = this.dialog.find(
                        ".uk-overflow-container:visible:first"
                    );
                    if (t.length) {
                        t.css("height", 0);
                        var i = Math.abs(
                        ...
                        return (
                            t.css({
                                maxHeight:
                                    o < this.options.minScrollHeight ? "" : o,
                                height: "",
                            }),
                            !0
                        );
            ...
            (t.modal.dialog = function (e, n) {
                var o = t.modal(
                    t.$(t.modal.dialog.template).appendTo("body"),
                    n
                );
                return (
                    o.on("hide.uk.modal", function () {
                        o.persist &&
                            (o.persist.appendTo(
                                o.persist.data("modalPersistParent")
                            ),
                            (o.persist = !1)),
                            o.element.remove();
                    }),
            ...
            (t.modal.blockUI = function (i, e) {
                var n = t.modal.dialog(
                    [
                        '<div class="uk-margin uk-modal-content">' +
                            String(
                                i || '<div class="uk-text-center">...</div>'
                            ) +
                            "</div>",
                    ].join(""),
                ...
                return (
                    (n.content = n.element.find(".uk-modal-content:first")),
                    n.show()
                );
            }),
        ...
        t.component("nav", {
            ...
            init: function () {
                ...
                this.on("click.uk.nav", this.options.toggle, function (e) {
                    ...
                    this.update(),
                    t.domObserve(this.element, function (t) {
                        i.element.find(i.options.lists).not("[role]").length &&
                            i.update();
                    });
            },
            update: function () {
                ...
                this.find(this.options.lists).each(function () {
                    ...
                    n.data("list-container") ||
                        ...
                        n.data(
                            ...
                            e
                                .parent()
                                [o ? "removeClass" : "addClass"]("uk-hidden")
                        )),
                ...
                this.options.multiple ||
                    ...
                    r &&
                        ...
                        n
                            ? (r
                                  .stop()
                                  .height(a.hasClass("uk-open") ? "auto" : 0),
                              a.hasClass("uk-open") || r.addClass("uk-hidden"),
                              this.trigger("display.uk.check"))
                            : r.stop().animate(
                                  {
                                      height: a.hasClass("uk-open")
                                          ? i(r.find("ul:first"))
                                          : 0,
                                  },
                                  function () {
                    ...
                    if (((n = t.$(n)), n.length)) {
                        ...
                        var s = t.$("body"),
                            ...
                            r =
                                ...
                                a.hasClass("uk-offcanvas-bar-flip") ? -1 : 1,
                        ...
                        (i.on(
                            ...
                            function (i) {
                                ...
                                if (
                                    ...
                                    if (
                                        e.parents(".uk-offcanvas-bar:first")
                                            .length
                                    )
                                        return;
                                }
                ...
                e.on(
                    ...
                    function (i) {
                        ...
                        if (!e.data("offcanvasTrigger")) {
                            t.offcanvasTrigger(
                                e,
                                t.Utils.options(e.attr("data-uk-offcanvas"))
                            );
                            e.trigger("click");
                        }
                    }
                  ...
                  (o = function () {
                      e &&
                          e
                              .hide()
                              .removeClass(
                                  "uk-active " + r + " uk-animation-reverse"
                              ),
                          n
                              .addClass(a)
                              .one(
                ...
                t.ready(function (i) {
                    t.$("[data-uk-switcher]", i).each(function () {
                        ...
                        if (!i.data("switcher")) {
                            t.switcher(
                                i,
                                t.Utils.options(i.attr("data-uk-switcher"))
                            );
                        }
                    });
                });
                ...
                this.on("click.uk.switcher", this.options.toggle, function (t) {
                    ...
                    this.options.connect &&
                        ...
                        this.connect.length &&
                            (this.connect.on(
                                "click.uk.switcher",
                                "[data-uk-switcher-item]",
                                function (e) {
                                    e.preventDefault();
                                    var n = t
                                        .$(this)
                                        .attr("data-uk-switcher-item");
                                    if (i.index != n)
                                        switch (n) {
                                            case "next":
                                            case "previous":
    ...
    (function (t) {
        ...
        t.component("tab", {
            ...
            check: function () {
                ...
                if (!i.length)
                    return void this.responsivetab.addClass("uk-hidden");
                var e,
                    n,
                    o,
                ...
                t.ready(function (i) {
                    t.$("[data-uk-cover]", i).each(function () {
                        ...
                        if (!i.data("cover")) {
                            t.cover(
                                i,
                                t.Utils.options(i.attr("data-uk-cover"))
                            );
                        }
                    });
                });
