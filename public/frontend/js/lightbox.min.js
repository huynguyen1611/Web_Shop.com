            ...
            i.$win.on(
                ...
                i.Utils.debounce(function () {
                    o.w !== window.innerWidth &&
                        ...
                        e.lightbox.fitSize(),
                        (o = { w: window.innerWidth, h: window.innerHeight });
                }, 100)
            ),
            (e.lightbox = t),
            e
            ...
            boot: function () {
                i.$html.on("click", "[data-uk-lightbox]", function (t) {
                    ...
                    e.data("lightbox") ||
                        i.lightbox(
                            e,
                            i.Utils.options(e.attr("data-uk-lightbox"))
                        ),
            ...
            fitSize: function () {
                ...
                u.appendTo("body").width(),
                    ...
                    e.title &&
                        ...
                        (r -= this.modal.dialog
                            .find(".uk-modal-caption")
                            .outerHeight())),
                    d < e.meta.width &&
                        ((g = Math.floor(g * (d / c))), (c = d)),
                    g > r &&
                        ((g = Math.floor(r)),
            ...
            init: function (i) {
                i.on("showitem.uk.lightbox", function (i, t) {
                    if (
                        "image" == t.type ||
                        (t.source &&
                            t.source.match(/\.(jpg|jpeg|png|gif|svg)$/i))
                    ) {
        ...
        i.plugin("lightbox", "youtube", {
            init: function (i) {
                ...
                i.on("showitem.uk.lightbox", function (i, s) {
                        ...
                        l = function (i, t, o) {
                            (s.meta = {
                                content:
                                    ...
                                    o +
                                    '" style="max-width:100%;"' +
                                    (e.lightbox.options.allowfullscreen
                                        ? " allowfullscreen"
                                        : "") +
                                    "></iframe>",
                                width: t,
                    ...
                    if (
                        ((a = s.source.match(t)) && (h = a[2]),
                        (a = s.source.match(n)) && (h = a[1]),
                        h)
                    ) {
        ...
        UIkit.plugin("lightbox", "iframe", {
            init: function (i) {
                i.on("showitem.uk.lightbox", function (t, o) {
                    ...
                    ("iframe" === o.type || o.source.match(/\.(html|php)$/)) &&
                        n(
                            o.source,
                            i.options.width || 800,
                            i.options.height || 600
                        );
                });
            },
        }),
