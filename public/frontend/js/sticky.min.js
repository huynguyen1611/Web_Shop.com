                ...
                if (((h = i[u]), h.element.is(":visible") && !h.animate)) {
                    if (h.check()) {
                        if (
                            (h.top < 0
                                ? (o = 0)
                                : ((r = h.element.outerHeight()),
                                  (o =
                                      c - r - h.top - h.options.bottom - p - d),
                                  (o = 0 > o ? o + h.top : h.top)),
                            h.boundary && h.boundary.length)
                        ) {
                            var f = h.boundary.offset().top;
                            (a = h.boundtoparent
                                ? c -
                                  (f + h.boundary.outerHeight()) +
                                  parseInt(h.boundary.css("padding-bottom"))
                                : c - f),
                                (o =
                                    p + r > c - a - (h.top < 0 ? 0 : h.top)
                                        ? c - a - (p + r)
                                        : o);
                        }
                        if (h.currentTop != o) {
                            if (
                                (h.element.css({
                                    position: "fixed",
                                    top: o,
                                    width: h.getWidthFrom.length
                                        ? h.getWidthFrom.width()
                                        : h.element.width(),
                                }),
                                !h.init &&
                                    (h.element.addClass(h.options.clsinit),
                                    location.hash && p > 0 && h.options.target))
                            ) {
                            ...
                            h.element
                                .addClass(h.options.clsactive)
                                .removeClass(h.options.clsinactive),
                                h.element.trigger("active.uk.sticky"),
                                h.element.css("margin", ""),
                                h.options.animation &&
                                    h.init &&
                                    !t.Utils.isInView(h.wrapper) &&
                                    h.element.addClass(h.options.animation),
                                (h.currentTop = o);
                        }
            ...
            init: function () {
                ...
                (this.wrapper = this.element
                    ...
                    (this.sticky = {
                        ...
                        init: !1,
                        getWidthFrom: t.$(
                            this.options.getWidthFrom || this.wrapper
                        ),
                        boundary: a,
                        boundtoparent: i,
                        top: 0,
                        calcTop: function () {
                            ...
                            if (
                                this.options.top &&
                                "string" == typeof this.options.top
                            )
                                if (this.options.top.match(/^(-|)(\d+)vh$/))
                                    i =
                                        (window.innerHeight *
                                            parseInt(this.options.top, 10)) /
                                        100;
                                else {
